...
| [`06_nbody_simulation_benchmark.py`](./06_nbody_simulation_benchmark.py) | N-Body celestial orbital benchmark from The Computer Language Benchmarks Game. | Symplectic Integrator, `@accelerate`, Fallback Safety |
