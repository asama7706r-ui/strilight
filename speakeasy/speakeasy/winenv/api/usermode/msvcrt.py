...
class Msvcrt(api.ApiHandler):
    ...
    def __p__environ(self, emu, argv, ctx: api.ApiContext = None):
        """char *** __p__environ ()"""
        ptr_size = self.get_ptr_size()
        ptr = self.mem_alloc(size=ptr_size, tag="api.environ")
        return ptr
